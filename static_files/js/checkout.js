$(function (){
    ...
    IMP.init('imp13294039'); //import  관리자 페이지에 있는 가맹점 식별코드를 입력해야 함

    $('.order-form').on('submit', function (e){ // order_form 에 submit 버튼을 눌렀을 때 function을 동작시킴
...
function AjaxCreateOrder(e){
    e.preventDefault(); //form 이 submit 되는 것을 막아줌
    var order_id = '';
